...
import { useNuevaVenta } from "./useNuevaVenta"; // Este hook es el de ventas
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        <Button
                          ...
                          disabled={productos.length === 0 || (field.value?.length || 0) >= productos.length}
                        >
                          Agregar Producto
                        </Button>
                        <br />
                        ...
                        <div className="text-right text-lg font-semibold">
                          Total: ${FormateoPrecio(totalVenta)}
                        </div>
                      </div>
                    </div>
                  </FormControl>
